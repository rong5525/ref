...
def generate_root_index_html(root_folder):
    ...
    为根文件夹生成index.html。
    """
    folder_counter = 1  # 初始化一级子文件夹的计数器
...
<body>
    ...
    for first_level_folder in sorted(os.listdir(root_folder)):
        ...
        if os.path.isdir(first_level_path):
            html_str += f'  <div class="folder-row"><span class="folder-name">{folder_counter}. {first_level_folder}:</span>\n'
            folder_counter += 1  # Increment the folder counter
